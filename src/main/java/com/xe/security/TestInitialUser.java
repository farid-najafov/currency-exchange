...
public class TestInitialUser {
    ...
    public void create() {
        ...
        String encode = enc.encode(new String("111"));
        String encode2 = enc.encode(new String("222"));
        String encode3 = enc.encode(new String("333"));

        User user1 = new User("Ferid",encode ,encode, "f@mail.ru", f,"USER");
